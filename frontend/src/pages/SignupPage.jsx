                ...
                <Box
                    ...
                    <Stack spacing={4}>
                        ...
                        <FormControl id="password" isRequired>
                            ...
                            <InputGroup>
                                <Input type={showPassword ? 'text' : 'password'} value={user.password} name="password" placeholder='Enter Password' onChange={handleChange} color={"black"} />
                        ...
                        <Stack pt={6}>
                            <Box display={"flex"} justifyContent={"center"} gap={"5px"}>
                                <Text color={"black"}>Already a user?</Text>
                                <Link to="/login">
