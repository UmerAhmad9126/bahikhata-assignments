...
import { Box, VStack, HStack, Text, Textarea, Center, Button } from "@chakra-ui/react";
...
function NotePage() {
    ...
    return (
        <HStack spacing={0} height="100vh" alignItems="stretch">
            <Box w="300px" bg="gray.800" color="white" p={4} display={"flex"} flexDirection={"column"} justifyContent={"space-between"}>
